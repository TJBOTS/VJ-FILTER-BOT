...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002144292299'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movie_studio_support_group') # Support Chat Link Without https:// or @
